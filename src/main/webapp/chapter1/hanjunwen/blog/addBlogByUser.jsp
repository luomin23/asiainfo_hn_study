...
<article>
    <div class="blog">
        <!-- blog list begin-->
        <h2><a href="/">发表博客：</a></h2>
        <form action="/addBlogByUser.do" method="post" enctype="multipart/form-data">
            主题:<input type="text" name="title" required><br>
            内容:<textarea name="article" style="height: 250px;width: 350px;resize: none;" required ></textarea><br>
            图片：<input type="file" name="image" enctype="multipart/form-data"><br>
