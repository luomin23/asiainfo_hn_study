...
public class Pay {
    ...
    public void calcPrice() {
        ...
        for (; l < goodsName.length && goodsName[l] != null; l++) {
            d4++;
            System.out.println((new StringBuilder()).append(d4).append(": ").append(goodsName[l]).append("\t").toString());
        }
        ...
        do {
            ...
            if (custNo[j1] == i) {
                ...
                System.out.println((new StringBuilder()).append("本次购物所获的积分是： ").append(i1).toString());
                break;
            }
            j1++;
        } while (true);
