...
public class Example1 {
        ...
        public static void main(String[]args){
            System.out.println("1,添加模块");
            add();
            System.out.println("2.删除模块");
            remove();
            System.out.println("3,修改模块");
            alter();
        }
        ...
        public static void remove(){
            ...
            sb.deleteCharAt(2);//指定位置的删除
            System.out.println("删除指定位置的结果哦："+sb);
            sb.delete(0,sb.length());//清除缓冲区
            System.out.println("清除缓冲区的内容："+sb);
        }
        public static void alter(){
            ...
            System.out.println("字符串的翻转结果："+sb.reverse());
